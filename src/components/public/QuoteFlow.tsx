  ...
  return <section className={styles.shell} aria-labelledby="quote-title">
    ...
    <form className={`${styles.form} ${step === 2 ? bookingStyles.calendarForm : ""}`} onSubmit={submit} noValidate aria-busy={isSubmitting}>
      ...
      {step === 4 ? <div className={bookingStyles.review}>
        ...
        <div className={bookingStyles.paymentNote}><span>₦</span><p><strong>Payment is not taken in this flow.</strong>{quote?.requiresReview ? " BOOM will confirm your scope and price before reserving a team." : " BOOM will confirm availability and payment before your appointment is reserved."}</p></div>
      </div> : null}
